...
- `mcp_servers` (String) MCP servers, as a JSON array. Treated as an unordered set: refreshed on read, with server ordering and enrichment tolerated, so multi-server agents plan cleanly on import.
